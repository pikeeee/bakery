                                ...
                                <div className="footer footer__contact">
                                    ...
                                    <div className="footer__address">
                                        ...
                                        <div className="footer__phone">
                                            ...
                                            <a href="# ">+(84)949 699 412</a>
                                        </div>
                                        <div className="footer__mail">
                                            <i className='bx bx-mail-send'></i>
                                            <a href="# ">powpow824@gmail.com</a>
                                        </div>
                                    </div>
                                    <div className="footer__socials">
                                        <a href="https://www.facebook.com/ng.hoangminh1999/">
                                            <i className='bx bxl-facebook'></i>
                                        </a>
                                        <a href="https://www.instagram.com/unknown_nn_nn_n_n_nn/">
                                            <i className='bx bxl-instagram'></i>
                                        </a>
                                        <a href="https://www.facebook.com/ng.hoangminh1999/">
                                            <i className='bx bxl-twitter'></i>
                                        </a>
                                        <a href="https://www.linkedin.com/in/nghoangminh185/">
                                            <i className='bx bxl-linkedin'></i>
                                        </a>
                                        <a href="https://github.com/powpow82444444">
